 ...
 */
public class VentanaEditarEntrada extends javax.swing.JFrame {

    private Conexion conexion = new Conexion();
    /**
     * Creates new form VentanaNuevoCliente
     */
    public VentanaEditarEntrada() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Editar Entrada");

        lblBarco.setText("Barco");

        lblEmpleado.setText("Empleado");

        lblID.setText("Id de la entrada:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEditarEntrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEditarEntrada().setVisible(true);
            }
        });
    }
