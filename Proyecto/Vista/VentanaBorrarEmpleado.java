 ...
 */
public class VentanaBorrarEmpleado extends javax.swing.JFrame {

    private Conexion conexion = new Conexion();
    /**
     * Creates new form VentanaBorrarCliente
     */
    public VentanaBorrarEmpleado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Borrar Empleado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBorrarEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaBorrarEmpleado().setVisible(true);
            }
        });
    }
